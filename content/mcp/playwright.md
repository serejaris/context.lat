...
Playwright MCP сервер позволяет AI управлять браузером: открывать страницы, кликать по элементам, заполнять формы, делать [скриншоты](/guides/testing-with-ai/).
