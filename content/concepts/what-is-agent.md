...
Каждый агент работает по паттерну ReAct — цикл из рассуждения, действия и наблюдения. Подробнее: [Агентский цикл](/concepts/agentic-loop/).
...
Траектория понятна: агенты будут справляться со всё более сложными задачами с меньшим [участием человека](/concepts/human-in-the-loop/). Но пока мы не там. Сегодняшние агенты нуждаются в присмотре.
