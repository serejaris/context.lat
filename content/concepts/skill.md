...
Скиллы — переиспользуемые промпты в формате файлов `[skill.md](/concepts/claude-md/)`, хранящиеся в папке `.claude/skills/`. Это программирование агента на естественном языке: один раз описываешь процедуру — агент выполняет её по команде. Аналог SOP (Standard Operating Procedure) для AI-агентов.

Работают в [Claude Code](/tools/claude-code/), Cursor, VS Code.
