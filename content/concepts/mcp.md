...
Без MCP [Claude Code](/tools/claude-code/) умеет читать и писать файлы, запускать команды. С MCP — [управлять браузером](/mcp/playwright/), делать [веб-поиск](/mcp/exa/), обращаться к [базам данных](/mcp/postgres/), работать с Notion, GitHub и любым другим сервисом.
