...
| Сервис | Стоимость |
|--------|----------|
| Claude Code | Бесплатный тариф покрывает базовое использование |
...
| Anthropic API | Оплата за токены: от $1/млн (Haiku) до $15/млн (Sonnet). Зависит от объёма |

Портфолио на Vercel + Supabase free = $0. Приложение с AI-функциями — зависит от трафика, но для личных проектов обычно укладывается в $5-15/мес.
