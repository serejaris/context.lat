...
[Exa — поисковик](/mcp/exa/) для AI-агентов. Не для тебя — для агента. Ты подключаешь [MCP](/concepts/mcp/)-сервер один раз, и дальше агент сам решает когда ему нужно загуглить: натыкается на ошибку, встречает незнакомый API, нужна свежая документация — он идёт и ищет. Без твоего участия.
